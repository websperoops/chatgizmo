...
<?php } else { ?>
  <div class="alert alert-info"><?php echo sprintf($jkl['i14'], $totalAll, $jakosub['chatwidgets'], $jkl['m26']);?></div>

  <?php if ($totalAll > 1 && $totalAll > $jakosub['chatwidgets']) { ?>
	...
	<div class="card">
		<div class="card-header">
	  	...
	  	<div class="card-body">
			...
			<?php foreach($CHATWIDGET_ALL as $i => $v) { ?>
			<tr>
			<td></td>
