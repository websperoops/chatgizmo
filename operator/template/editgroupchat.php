...
<div class="row">
	...
	<div class="col-md-8">
		...
		<p><textarea class="form-control" id="widget-code" readonly="readonly" rows="11"><?php echo htmlentities('<!-- Cloud Chat 3 Group Chat Widget -->
...
<!-- end Cloud Chat 3 Group Chat Widget -->');?></textarea></p>
				...
				<?php echo htmlentities('<a href="'.str_replace(JAK_OPERATOR_LOC."/", "", JAK_rewrite::jakParseurl('groupchat', $page2, $JAK_FORM_DATA["lang"])).'">'.$jkl['g306'].'</a>');?>
				</div>
			</div>
		</div>
...
<div class="row">
	...
	<div class="col-md-8">
		<div class="card">
		<div class="card-header">
		  <h3 class="card-title"><i class="fa fa-palette"></i> <?php echo $jkl["m5"];?></h3>
		</div><!-- /.box-header -->
		<div class="card-body">

			<div class="form-group">
				<label for="jak_floatcss"><?php echo $jkl["g358"];?></label>
