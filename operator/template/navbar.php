...
<?php } if (jak_get_access("groupchat", $jakuser->getVar("permissions"), JAK_MAIN_OP)){?>
...
<?php } if (jak_get_access("bot", $jakuser->getVar("permissions"), JAK_MAIN_OP)){?>
...
<?php } ?>
<li<?php if ($page == 'tickets') echo ' class="active"';?>><a href="<?php echo JAK_rewrite::jakParseurl('tickets');?>"><i class="fas fa-ticket-alt"></i> <p><?php echo $jkl["m31"];?></p></a></li>
</ul>