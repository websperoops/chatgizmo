	  	...
	  	<div class="card-body">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<td><a class="btn btn-secondary btn-sm" href="<?php echo str_replace(JAK_OPERATOR_LOC."/", "", JAK_rewrite::jakParseurl('groupchat', $v["id"], $v["lang"]));?>" target="_blank"><i class="fa fa-comments"></i></a></td>
