        ...
        <label class="form-check-label">
          ...
          <?php } ?>
            ...
            <div class="form-group">
				...
				<input type="number" name="jak_proactive_time" id="proactive_time" class="form-control" min="1" max="30" step="1" value="<?php echo JAK_PROACTIVE_TIME;?>"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>
			...
			<div class="form-group">
				...
				<input type="number" name="jak_user_left" id="user_left" class="form-control" min="30" max="1800" step="1" value="<?php echo JAK_CLIENT_LEFT;?>"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>
			...
			<div class="form-group">
				...
				<input type="number" name="jak_user_expired" id="user_expire" class="form-control" min="120" max="2000" step="1" value="<?php echo JAK_CLIENT_EXPIRED;?>"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>
			...
			<div class="form-group">
				...
				<input type="number" name="jak_pushrem" id="pushrem" class="form-control" min="15" max="300" step="1" value="<?php echo JAK_PUSH_REMINDER;?>"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>
			...
			<div class="form-group">
				...
				<input type="text" name="allowed_files" id="clientfiles" class="form-control<?php if (isset($errors["e3"])) echo " is-invalid";?>" value="<?php echo JAK_ALLOWED_FILES;?>" placeholder=".zip,.rar,.jpg,.jpeg,.png,.gif"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>

			<div class="form-group">
				<label for="opfiles"><?php echo $jkl["g128"];?></label>
				<input type="text" name="allowedo_files" id="opfiles" class="form-control<?php if (isset($errors["e3"])) echo " is-invalid";?>" value="<?php echo JAK_ALLOWEDO_FILES;?>" placeholder=".zip,.rar,.jpg,.jpeg,.png,.gif"<?php if (!JAK_SUPERADMINACCESS) echo " readonly";?>>
			</div>
