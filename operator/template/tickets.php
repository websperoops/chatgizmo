		...
		<div class="card-header">
	  	...
	  	<div class="card-body">
	  		<div class="table-responsive">
				...
				<td><?php echo $v["id"];?></td>
				<td><a href="<?php echo JAK_rewrite::jakParseurl('tickets', 'a', $v["id"]);?>"><?php echo $v["subject"];?></a></td>
				<td><?php echo ls_cut_text($v["content"], 60, "...");?></td>
				<td><a class="btn btn-default btn-sm" href="<?php echo JAK_rewrite::jakParseurl('tickets', 'r', $v["id"]);?>"><i class="fa fa-file-alt"></i></a></td>
